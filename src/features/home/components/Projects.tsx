    ...
    return (
        <section id="projects" className="py-24 bg-surface overflow-hidden">
            <div className="max-w-[1400px] mx-auto px-8">
                ...
                >
                    <div>
                        <span className="text-tertiary text-xs font-bold tracking-[0.3em] uppercase block mb-4">{dict.badge}</span>
                        <h2 className="font-headline text-4xl md:text-5xl font-bold text-on-surface">{dict.title}</h2>
                    </div>
                    <div className="flex gap-4">
                        {[dict.filterAll, dict.filterIndustrial, dict.filterCommercial, dict.filterResidential].map((filter, idx) => (
                            <button key={idx} className={`text-xs font-bold uppercase tracking-widest px-4 py-2 transition-colors ${idx === 0 ? 'border-b-2 border-tertiary text-tertiary' : 'text-on-surface-variant hover:text-on-surface'}`}>
                                {filter}
                            </button>
                        ))}
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    >
                        ...
                        />
                        <div className="absolute inset-0 bg-primary-container/80 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-12">
                    ...
                    >
                        ...
                        />
                        <div className="absolute inset-0 bg-primary-container/80 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-8">
