...
export default function Services({ dict, isRtl = true }: { dict: any; isRtl?: boolean }) {
        ...
        <section className="py-24 px-8 md:px-24 bg-surface-container-low overflow-hidden">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <div className={`h-1 w-32 md:w-48 rounded-full ${isRtl ? "bg-gradient-to-l" : "bg-gradient-to-r"} from-tertiary to-transparent mx-auto`} aria-hidden />
                </motion.div>
                <motion.div
