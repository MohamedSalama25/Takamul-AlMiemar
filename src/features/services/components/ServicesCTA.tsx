    ...
    return (
        <section className="py-32 bg-background text-center">
            <div className="max-w-3xl mx-auto px-8">
                ...
                <button className="bg-tertiary text-on-tertiary px-12 py-5 text-sm font-bold tracking-[0.2em] uppercase hover:bg-tertiary/90 transition-all duration-300 shadow-[0_10px_40px_rgba(212,175,55,0.2)]">
                    {dict.button}
                </button>
            </div>
        </section>
